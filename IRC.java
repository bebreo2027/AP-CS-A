...
public class IRC {
    ...
    public static void main(String[] args) {
        ...
        myCalc.setInAmount(scan.nextInt());
        ...
        myCalc.setMonthAmount(scan.nextInt());
        //Print out the result by running the calcPayments method
        System.out.println("""
                           Interest rate over that amount of months:
                           $""" + roundAvoid(myCalc.calcPayments(), 2));
    }
    //Make a roundAvoid method that rounds decimals
...
class InterestRateCalculator {
    ...
    public void setMonthAmount (int inMonth) {
