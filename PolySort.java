...
class Contact implements Comparable
{
    ...
    public int compareTo(Object other)
    {
        ...
        if (phoneValue(phone) != phoneValue(otherPhone))
        {
            result = Integer.compare(phoneValue(phone), phoneValue(otherPhone));
        }
    ...
    private int phoneValue(String phoneString) 
    {
            int result = Integer.parseInt(phoneString.substring(0, 3) +  phoneString.substring(4, 7) +   phoneString.substring(8));
            return result;
    }
}