...
public class CourseDetails {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Title of the course: " + myAPEnvironmentalScience.getTitle() + "\n"
            + "Code of the course: " + myAPEnvironmentalScience.getCode() + "\n"
            + "Point total of the course: " + myAPEnvironmentalScience.getPointsTotal() + "\n"
            + "Name of the course's instructor: " + myAPEnvironmentalScience.getInstructorName());
        //toString prints out the course description
